...
public  List<Product> listerFavoriProductByIdList(List<Long> list )	
{
	List<Product> listFavori = new ArrayList<Product>() ;
	
	
	  for(int i = 0; i < list.size(); i++)
	    {
		  listFavori.add(this.getProductById(String.valueOf(list.get(i) ) ) )  ;
		  /*test*/
		  System.out.println(listFavori.get(i).getName()); 
	      /*test*/
	    }
